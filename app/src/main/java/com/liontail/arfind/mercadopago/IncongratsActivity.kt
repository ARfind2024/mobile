...
class IncongratsActivity : AppCompatActivity() {

    private lateinit var sharedPreferences: SharedPreferences
    lateinit var btn: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_incongrats)
        ...
        lifecycleScope.launch {
            ...
            SharedReferencesPresenter.cargarSharedReferences { success ->
                if (success) {
                    ...
                    Toast.makeText(this@IncongratsActivity, "Error al cargar las referencias compartidas", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
