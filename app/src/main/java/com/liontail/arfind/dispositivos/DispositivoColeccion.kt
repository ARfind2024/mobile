...
object DispositivoColeccion {
    ...
    fun obtenerDispositivosByUsuarioAsync(): CompletableFuture<List<DispositivoDto>> {
        val future = CompletableFuture<List<DispositivoDto>>()

        val call: Call<List<DispositivoDto>> = apiService.getDispositivosByUsuario()
